...
fn main() {
    ...
    let mut aig = 
        ...
        // Aig::from_file("../MC-Benchmark/hwmcc15/single/vis4arbitp1.aag")// 110s vs 64ms
        // Aig::from_file("../MC-Benchmark/hwmcc19/single/aig/goel/industry/cal9/cal9.aag") // ? vs 30s
        Aig::from_file("../MC-Benchmark/hwmcc19/single/aig/goel/opensource/vis_arrays_buf_bug/vis_arrays_buf_bug.aag") // both fast
