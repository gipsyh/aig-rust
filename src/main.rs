...
fn main() {
    ...
    let mut aig = 
        ...
        // Aig::from_file("../MC-Benchmark/hwmcc15/single/vis4arbitp1.aag")// 10s vs 64ms
        Aig::from_file("../MC-Benchmark/hwmcc08/viseisenberg.aag")  // 44s vs 1s
